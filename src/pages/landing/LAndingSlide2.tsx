...
const LAndingSlide2 = () => {
    const OurServicesImages = [
        { id: "01", src: '/rentCar/carRent-images/services/1.jpg', text:"Corporate Car Rental" },
        { id: "02", src: '/rentCar/carRent-images/services/2.jpg', text:"Car Rental with Driver" },
        { id: "03", src: '/rentCar/carRent-images/services/3.jpg', text:"Airport Transfer" },
        { id: "04", src: '/rentCar/carRent-images/services/4.jpg', text:"Fleet Leasing" },
        { id: "05", src: '/rentCar/carRent-images/services/5.jpg', text:"VIP Transfer" },
        { id: "06", src: '/rentCar/carRent-images/services/6.jpg', text:"Private Transfer" }
      ];
