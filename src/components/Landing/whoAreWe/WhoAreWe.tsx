import {  HeavyCheckMark, PlayLineDuotone } from "../../../icons/icons"
     ...
     <div className="container  mx-auto ">
        <div className=" w-full mx-auto max-lg:px-[12px] max-w-[1200px] grid grid-cols-2 max-md:grid-cols-1 gap-y-5 ">
          <div className="shrink-0">
            ...
            {
              whoAreWeText?.text?.map((text,i)=> (
                <Reveal key={i}>
                  <p className="text-[#999] text-[14px] font-[300] leading-[1.95rem] mb-[15px]  last-of-type:mb-[30px] break-words " > {text} </p>
                </Reveal>
              ))
            }
            <div className=" flex flex-col gap-4 mb-[30px]">
                {
                  whoAreWeText?.list?.map((List:string,i:number)=> (
                    <Reveal key={i}>
          ...
          <Reveal width="100%">
            ...
            image='/rentCar/carRent-images/about.jpg'/>
          </Reveal>
