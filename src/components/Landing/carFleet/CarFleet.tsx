...
const images = [
  { id: 1, src: '/rentCar/carRent-images/slider/7.jpg', text: "VIP Transfer" },
  { id: 2, src: '/rentCar/carRent-images/slider/1.jpg', text: "Private Transfer" },
  { id: 3, src: '/rentCar/carRent-images/slider/9.jpg', text: "Corporate Car Rental" },
  { id: 4, src: '/rentCar/carRent-images/slider/8.jpg', text: "Car Rental with Driver" },
  { id: 5, src: '/rentCar/carRent-images/slider/3.jpg', text: "Airport Transfer" }
];
const CarFleet = () => {
